import { AttributeCompare, DiffRender, NodeCompare } from 'dom';
import { isEquals, isNull } from '../utils';
 ...
 * @returns
 */
const render: DiffRender = ($element, realNode, virtualNode) => {
 ...
 * @returns
 */
const isChangedNode: NodeCompare = (realNode, virtualNode) => {
 ...
 * @returns
 */
const isDifferenceAttributes: NodeCompare = (realNode, virtualNode) => {
 ...
 * @returns
 */
const isEqualsAttribute: AttributeCompare = (node1, node2, name1, name2) =>
 ...
 * @returns
 */
const isNotEqualsLastContent: NodeCompare = (realNode, virtualNode) => {
 ...
 * @returns
 */
const isNodeNotEquals: NodeCompare = (node1, node2) => node1.nodeName !== node2.nodeName;
 ...
 * @returns
 */
const isOnlyExistLeft: NodeCompare = (node1, node2) => node1 && !node2;
 ...
 * @returns
 */
const isOnlyExistRight: NodeCompare = (node1, node2) => !node1 && node2;
