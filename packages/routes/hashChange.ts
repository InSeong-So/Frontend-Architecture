import { notationConvert } from '@/helpers/utils';
import { HashRouteCallback, RouterParams, RoutesProps } from 'route';
...
export default class Router {
  ...
  start = () => {
    ...
    if (!this.$global.location.hash) this.$global.location.hash = '#/';
    this.checkRoutes();
